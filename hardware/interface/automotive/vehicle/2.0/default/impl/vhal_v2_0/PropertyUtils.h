...
constexpr int LIGHT_BRIGHT_NESS_LEVEL = (int)LightBrightnessLevel::LEVEL_3;   // LightBrightnessLevel
constexpr int WHEEL_RESERVED = (int)VehicleAreaWheel::RESERVED;
constexpr int WHEEL_TYRE_RECEIVERSTATE = (int)VehicleAreaWheel::TYRE_RECEIVERSTATE;
